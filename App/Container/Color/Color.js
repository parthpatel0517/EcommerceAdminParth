...
// import { Deletbrand, addbrand, , updatebrand } from '../../redux/Slice/brand.slice';
import { Deletcolor, Deletecolor, addcolor, getcolor, updatecolor } from '../../redux/Slice/color.slice';
    ...
    return (
        <ScrollView>
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <Text style={styles.modalText}>Add Color Name</Text>
                        <TextInput
                            style={styles.input}
            ...
            <TouchableOpacity
                ...
                <Text style={styles.textStyle}>Add Color name</Text>
            </TouchableOpacity>
