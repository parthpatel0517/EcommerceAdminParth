...
export const getcategorydata = () => async (dispatch) => {
    ...
    try {
        ...
        const response = await axios.get("http://192.168.1.6:8000/api/v1/categories/list-categories", { headers: {"Authorization" : `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzExMWM1NTY1MGM3ZTEwZDcxNGFjZjEiLCJyb2xlIjoiYWRtaW4iLCJleHBpcmVzSW4iOiIxIGhvdXJzIiwiaWF0IjoxNzI5MjU1MjkwLCJleHAiOjE3MjkyNTg4OTB9.ddg4iMjJjCKdKBDJacciEHJVTbMVrEk9vk0FHjPidi4`} });
...
export const addcategory = (data) => async (dispatch) => {
    ...
    try {
        ...
        //     console.log(errors)
        //     )
        // const response = await axios.post("http://192.168.1.6:8000/api/v1/categories/add-category", 
